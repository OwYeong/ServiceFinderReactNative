                        ...
                        <View style={styles.bigContainer}>
                            {chatrooms.map(chatroom => (
                                <TouchableRipple
                                    ...
                                    <View style={{width: '100%', flexDirection: 'row', padding: 16, paddingVertical:8}}>
                                        <View style={{width: 60, borderRadius: 30, overflow: 'hidden'}}>
                                            {chatroom?.opponentUserInfo?.accType == Constants.ACCOUNT_TYPE.VENDOR ? (
                                        ...
                                        <View style={{justifyContent: 'center', marginLeft: 12}}>
                                            ...
                                            <Text
                                                ...
                                                {_.truncate(chatroom?.lastMessageBy == auth().currentUser.uid ? 'You: '+chatroom?.lastMessage.replaceAll('\n',''):chatroom?.lastMessage.replaceAll('\n',''), {
                                                    length: 30,
                                                })}
                                            </Text>
                                        </View>
