                ...
                reviewsCollection
                    ...
                    .then(async docRef => {
                        ...
                        try {
                            ...
                            const providerInfo = await ProviderService.getProviderByIdOneTimeRead(data.serviceProviderId);
                            ...
                            const newAverageRating = ((oldTotalNumOfReview* providerInfo.averageRatings) + data.numOfStar) / (oldTotalNumOfReview + 1);
                            await ProviderService.updateProviderData({
                                averageRatings: newAverageRating,
                                [`starStats.numOf${data.numOfStar}Star`]: firebase.firestore.FieldValue.increment(1),
