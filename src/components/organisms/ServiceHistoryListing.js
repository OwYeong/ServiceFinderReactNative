...
const ServiceHistoryListing = () => {
    ...
    useEffect(() => {
        const unsubscriber = RequestService.getHistoryRequestByCustomer(setRequests);
                                ...
                                <View>
                                    ...
                                    <View
                                        ...
                                        <Text
                                            ...
                                            {request.serviceStatus == Constants.SERVICE_STATUS.CANCELLED_BY_CUSTOMER
...
export default ServiceHistoryListing;
